...
def main():
    ...
    cta_group = parser.add_mutually_exclusive_group()
    cta_group.add_argument("--cta-file", type=Path, help="Optional installer-provided final CTA")
    cta_group.add_argument("--no-cta", action="store_true", help="Explicitly request no fixed CTA check")
